  ...
  return (
    <section className="py-12 bg-gray-50">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        {/* Premium Quality */}
        <div className="flex items-center gap-4 bg-white p-4 rounded-lg shadow-md">
          <img src="/images/quality.png" alt="Premium Quality" className="h-12 w-12" />
          <div>
        ...
        {/* Easy Returns */}
        <div className="flex items-center gap-4 bg-white p-4 rounded-lg shadow-md">
          <img src="/images/returns.png" alt="Easy Returns" className="h-12 w-12" />
          <div>
        ...
        {/* 24/7 Support */}
        <div className="flex items-center gap-4 bg-white p-4 rounded-lg shadow-md">
          <img src="/images/support.png" alt="24/7 Support" className="h-12 w-12" />
          <div>
